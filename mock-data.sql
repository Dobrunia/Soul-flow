...
INSERT INTO messages (chat_id, sender_id, content, message_type, created_at) VALUES 
  -- Общий чат
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Привет! Как дела? 👋', 'text', NOW() - INTERVAL '2 hours'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '6dd315e4-6901-4780-b830-d7c105f5ee5f', 'Отлично! Работаю над новым проектом', 'text', NOW() - INTERVAL '1 hour'),
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Звучит интересно! Расскажешь подробнее?', 'text', NOW() - INTERVAL '5 minutes'),
  
  -- Рабочие вопросы
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Нужно обсудить техническое решение', 'text', NOW() - INTERVAL '30 minutes'),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '6dd315e4-6901-4780-b830-d7c105f5ee5f', 'Согласен, давайте созвонимся завтра', 'text', NOW() - INTERVAL '15 minutes'),
  
  -- Личная переписка
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', '6dd315e4-6901-4780-b830-d7c105f5ee5f', 'Можешь помочь с багом в коде?', 'text', NOW() - INTERVAL '10 minutes'),
  ('cccccccc-cccc-cccc-cccc-cccccccccccc', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Конечно! Скинь описание проблемы', 'text', NOW() - INTERVAL '2 minutes'),
  
  -- Проектные идеи
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', '6dd315e4-6901-4780-b830-d7c105f5ee5f', 'У меня есть идея для нового фичера', 'text', NOW() - INTERVAL '3 minutes'),
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Слушаю внимательно! 🎯', 'text', NOW() - INTERVAL '1 minute'),
  
  -- Быстрые заметки
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '4907c7ba-ff50-4b11-bde8-6822438d7226', 'Заметка: не забыть обновить документацию', 'text', NOW() - INTERVAL '45 minutes'),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '6dd315e4-6901-4780-b830-d7c105f5ee5f', 'Добавил в список задач ✅', 'text', NOW() - INTERVAL '30 minutes')
